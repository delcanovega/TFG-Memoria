...
La elección de Python \citep{python} como lenguaje para nuestras pruebas tiene muchos motivos. Para empezar se trata de un lenguaje de programación que te permite ponerte a trabajar muy rápidamente, no necesitas grandes entornos de desarrollo y su gestión de paquetes es rápida y sencilla, por lo que en apenas unos minutos puedes tener tu proyecto configurado y listo para trabajar en cualquier ordenador.

Además, durante los últimos años Python ha sido la opción por excelencia para el Aprendizaje Automático. Esto se traduce en una gran cantidad de recursos disponibles, ya sea en forma de frameworks, librerías de utilidades, documentación o una gran comunidad activa dispuesta a resolver tus dudas.

La distribución elegida de Python ha sido Anaconda \citep{anaconda}, la cual incluye muchas librerías básicas para trabajar en Aprendizaje Automático. Además de proporcionarte facilidades, como poder mantener distintas instalaciones de Python en entornos aislados con la seguridad de que los paquetes o configuraciones para otros proyectos no se verán alterados.

Algunas de las librerías que hemos usado han sido NumPy y Matplotlib. Numpy \citet{numpy} pone a tu disposición arrays multidimensionales y multitud de funciones para trabajar con ellos. Se trata de implementaciones de muy alto rendimiento en C, utilizadas a través de la comodidad y simpleza de Python. Matplotlib \citep{matplotlib} es una biblioteca para la generación de gráficas a partir de datos almacenados en arrays. Generar gráficas sencillas como las nuestras es rápido e intuitivo, pero la librería es lo bastante compleja como para permitirte generar cosas mucho más avanzadas.
