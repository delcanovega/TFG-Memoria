...
\figura{Bitmap\DQNEnAccion\mountainCar\mainPosNoAbsNew3}{width=0.8\textwidth}{fig:mountaincar_03}%
...
Como podemos ver, el rendimiento de la gráfica \ref{fig:mountaincar_04} sigue siendo muy parecido al visto en  \ref{fig:mountaincar_02}, la línea azul representa la puntuación modificada por nosotros y la roja la que devuelve el entorno. No es hasta después de los 1200 episodios cuando el agente consigue alcanzar la meta. A partir de los nuevos resultados podemos hacer las siguientes observaciones:
